...
r = cloudmesh.shell("cloud on {cloud}".format(**data))
print r

r = cloudmesh.shell("cloud select {cloud}".format(**data))
print r

r = cloudmesh.shell("project default {project}".format(**data))
print r

command = str('cluster create '
              ' --force'
              ' --count={count}'
              ' --group={groupname}'
              ' --ln={login}'
